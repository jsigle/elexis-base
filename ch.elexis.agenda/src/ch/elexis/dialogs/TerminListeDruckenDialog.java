 ...
 *                  In View Agenda xy oder Parallelanzeige, Wochenanzeige: ViewMenu: Tagesliste drucken (oder auf das Icon mit dem Drucker klicken)
 *                  The TerminListeDruckenDialog window should open, containing an OpenOffice client; and soffice.bin/soffice.exe should appear in the Task manager
 *                  Close the TerminListeDruckenDialog dialog window
...
public class TerminListeDruckenDialog extends TitleAreaDialog implements ICallback {
	...
	//20131028js: added this here instead of on-the-fly-declaration in createDialogArea() to be able use text.getPlugin... in close()...
	...
	public boolean close(){
		...
		System.out.println("\njs ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): begin");

		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: Added a close function with at least the text.getPlugin().dispose(); functionality");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: as also added to other TextContainer clients, to ensure that TextPlugin connection/server");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: is closed again after usage. Please review other commented out content of this dispose():");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: Does GenericPrintDialog need more functionality as well?");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		...
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: Bitte Prüfen: ist das gespeichert mit save() oder ähnlich, vor dem dispose?");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: Bitte Prüfen: Siehe info re added closeListener in TextView.java und below");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		...
		*/
		...
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): about to txt.getPlugin().dispose()");
		text.getPlugin().dispose();		
		
		/*
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): about to GlobalEventDispatcher.removeActivationListener()...");
		GlobalEventDispatcher.removeActivationListener(this, this);
		*/

		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): about to super.dispose()... - warum hier im Ggs. zu TextView NICHT actBrief = null?");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): about PLEASE NOTE: ein paar Zeilen weiter oben bei removeMonitorEntry() hab ich actBrief übergeben, wie in TextView.java.dispose() auch. Korrekt?");
		System.out.println("js ch.elexis.agenda/ch.elexis.dialogs/TerminListeDruckenDialog.java close(): TODO: !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
		//20131027js:
