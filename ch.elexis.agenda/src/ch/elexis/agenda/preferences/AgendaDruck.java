...
public class AgendaDruck extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public boolean performOk(){
		Hub.localCfg.set(PreferenceConstants.AG_PRINT_APPOINTMENTCARD_TEMPLATE,
			cTerminTemplate.getText());
		Hub.localCfg.set(PreferenceConstants.AG_PRINT_APPOINTMENTCARD_PRINTER_NAME,
			tTerminPrinter.getText());
		Hub.localCfg.set(PreferenceConstants.AG_PRINT_APPOINTMENTCARD_PRINTER_TRAY,
			tTerminTray.getText());
		Hub.localCfg.set(PreferenceConstants.AG_PRINT_APPOINTMENTCARD_DIRECTPRINT,
