...
public class DirectoriesContentParser extends HtmlParser {
	...
	public List<KontaktEntry> extractKontakte() throws IOException{
		...
		if (getNextPos("<meta content='Adresse von ")>0) {
			System.out.print("jsdebug: Processing a <meta> field to help processing the 'details' field later on which is very unstructured after 20131124...\n");
			...
			if (metaStrasseTrunc == null)	System.out.print("jsdebug: WARNING: metaStrasseTrunc == null\n");
			else							System.out.print("jsdebug: metaStrasseTrunc == "+metaStrasseTrunc+"\n");
			if (metaPLZTrunc == null)		System.out.print("jsdebug: WARNING: metaPLZTrunc == null\n");
			else							System.out.print("jsdebug: metaPLZTrunc == "+metaPLZTrunc+"\n");
			if (metaOrtTrunc == null)		System.out.print("jsdebug: WARNING: metaOrtTrunc == null\n");
			else							System.out.print("jsdebug: metaOrtTrunc == "+metaOrtTrunc+"\n");
		};		
...
System.out.println("TODO: DirectoriesContentParser.java: Shouldn't the \\\" in the following line and similar ones throughout this file be changed to a simple ' ???\n");
		...
		*/
		...
		while (doItOnceMore) { // 20120712js
			...
			*/
			...
			// String streetAddress = removeDirt(parser.extract("<span class=\"street-address\">",
			// "</span>")); // 20120712js:
			System.out.print("jsdebug: Trying to use Meta-Info collected above to parse the address content...\n");
			if (metaStrasseTrunc == null)	System.out.print("jsdebug: WARNING: metaStrasseTrunc == null\n");
			else							System.out.print("jsdebug: metaStrasseTrunc == "+metaStrasseTrunc+"\n");
			if (metaPLZTrunc == null)		System.out.print("jsdebug: WARNING: metaPLZTrunc == null\n");
			else							System.out.print("jsdebug: metaPLZTrunc == "+metaPLZTrunc+"\n");
			...
			for (String thisLine : addressLines) {
				if (thisLine != null)		{thisLine = thisLine.trim();};		//especially remove leading and trailing newlines. 
				if (thisLine == null)		System.out.print("jsdebug: WARNING: thisLine == null\n");
				else						{
			...
			if (poBoxB.equals("")) {poBox=poBoxA;}
			else {poBox=poBoxA+", "+poBoxB;};
		
		
			//20131127js:
			//Debug output zeigt, was herausgekommen ist:
			if (streetAddress == null)	System.out.print("jsdebug: WARNING: streetAddress == null\n");
			else						System.out.print("jsdebug: streetAddress == "+streetAddress+"\n");
			if (poBox == null)			System.out.print("jsdebug: WARNING: poBox == null\n");
			else						System.out.print("jsdebug: poBox == "+poBox+"\n");
			if (plzCode == null)		System.out.print("jsdebug: WARNING: plzCode == null\n");
			else						System.out.print("jsdebug: plzCode == "+plzCode+"\n");
			if (ort == null)			System.out.print("jsdebug: WARNING: ort == null\n");
			else						System.out.print("jsdebug: ort == "+ort+"\n");
