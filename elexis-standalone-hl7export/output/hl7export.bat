...
rem Bei Windows 64 Bit: "C:\Program Files (x86)\Java\jdk1.6.0_22\bin\java.exe" -jar hl7export-20131027.jar > hl7export.log 2> hl7export_error.log
rem bei Windows 32 Bit: java.exe -jar hl7export-20131027.jar > hl7export-20131027.log 2> hl7export_error.log
java.exe -jar hl7export-20131027.jar %1 %2 > hl7export.log 2> hl7export_error.log
