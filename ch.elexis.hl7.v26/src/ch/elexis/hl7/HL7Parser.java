...
public abstract class HL7Parser {
	protected static final String COMMENT_NAME = "Kommentar";
	protected static final String COMMENT_GROUP = "00 Kommentar";
	...
	public HL7Parser(final String sendingApplication1, final String sendingApplication3,
