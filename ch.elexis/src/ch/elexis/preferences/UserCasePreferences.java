...
public class UserCasePreferences extends FieldEditorPreferencePage implements
	...
	protected Control createContents(Composite parent){
		...
		btnUp.setImage(Desk.getImage(Desk.IMG_ARROWUP));
		...
		btnDown.setImage(Desk.getImage(Desk.IMG_ARROWDOWN));
		...
		btnToManual.setImage(Desk.getImage(Desk.IMG_MOVETOLOWERLIST));
		...
		btnToNotPresorted.setImage(Desk.getImage(Desk.IMG_ARROWDOWNTORECT));
