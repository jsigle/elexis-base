...
public class AtcClass {
	/*
	 * - code (String(1-7), NOT NULL)-> Atc-Code. siehe Glossar (AtcCode) - descriptions
	 * (SimpleLanguage::Descriptions (String, String)) -> Sprache, Bezeichnung. siehe Glossar
	 * (SimpleLanguage::Descriptions) - guidelines (Text::Document) -> Guidelines der WHO zum
	 * Atc-Code. Sprache: en - ddd_guidelines (Text::Document) -> Guidelines der WHO zu den
	 * DailyDoses. Sprache: en - ddds (Hash (DDD.administration_route, DDD) -> DailyDrugDose
	 * Informationen der WHO. siehe Glossar (DailyDrugDose)
	 */
	Map<String, String> descriptions; // (SimpleLanguage::Descriptions (String, String)) -> Sprache,
										// Bezeichnung. siehe Glossar (SimpleLanguage::Descriptions)
	Document guidelines; // (Text::Document) -> Guidelines der WHO zum Atc-Code. Sprache: en
	Document ddd_guidelines; // (Text::Document) -> Guidelines der WHO zu den DailyDoses. Sprache:
								// en
	// Map<String, DDD> ddds; // (Hash (DDD.administration_route, DDD) -> DailyDrugDose
	// Informationen der WHO. siehe Glossar (DailyDrugDose)
	List<DDD> ddds; // (Hash (DDD.administration_route, DDD) -> DailyDrugDose Informationen der WHO.
					// siehe Glossar (DailyDrugDose)
