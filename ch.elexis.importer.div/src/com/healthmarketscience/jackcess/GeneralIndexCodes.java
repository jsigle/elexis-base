...
public class GeneralIndexCodes extends GeneralLegacyIndexCodes {
	...
	private static final String CODES_FILE = Database.RESOURCE_PATH + "index_codes_gen.txt";
	private static final String EXT_CODES_FILE = Database.RESOURCE_PATH + "index_codes_ext_gen.txt";
