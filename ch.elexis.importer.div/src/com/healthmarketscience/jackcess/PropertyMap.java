...
public class PropertyMap implements Iterable<PropertyMap.Property> {
	...
	/**
	 * @return the value of the property with the given name, if any, otherwise the given
	 *         defaultValue
	 */
	...
	public void put(String name, DataType type, byte flag, Object value){
		_props.put(Database.toLookupName(name), new Property(name, type, flag, value));
	}
	...
	public String toString(){
		...
		sb.append(PropertyMaps.DEFAULT_NAME.equals(getName()) ? "<DEFAULT>" : getName()).append(
			" {");
