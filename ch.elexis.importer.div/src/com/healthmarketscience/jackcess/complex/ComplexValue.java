...
/**
 * Base class for a value in a complex column (where there may be multiple values for a single row
 * in the main table).
 * 
...
public interface ComplexValue {
	 ...
	 * 
	 * @return the current id or {@link ComplexColumnInfo#INVALID_ID} for a new, unsaved value.
	 */
	public int getId();
	 ...
	 * 
	 * @return the current id or {@link ComplexColumnInfo#INVALID_COMPLEX_VALUE_ID} for a new,
	 *         unsaved value.
	 */
