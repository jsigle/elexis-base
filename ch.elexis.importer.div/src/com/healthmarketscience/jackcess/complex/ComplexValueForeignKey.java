...
/**
 * Value which is returned for a complex column. This value corresponds to a foreign key in a
 * secondary table which contains the actual complex data for this row (which could be 0 or more
 * complex values for a given row). This class contains various convenience methods for interacting
 * with the actual complex values.
 * <p>
 * This class will cache the associated complex values returned from one of the lookup methods. The
 * various modification methods will clear this cache automatically. The {@link #reset} method may
...
public class ComplexValueForeignKey extends Number {
	...
	public Attachment addAttachment(String url, String name, String type, byte[] data,
		Date timeStamp, Integer flags) throws IOException{
		reset();
		Attachment a =
			AttachmentColumnInfo.newAttachment(this, url, name, type, data, timeStamp, flags);
	...
	public boolean equals(Object o){
		return ((this == o) || ((o != null) && (getClass() == o.getClass())
			&& (_value == ((ComplexValueForeignKey) o)._value) && (_column == ((ComplexValueForeignKey) o)._column)));
	}
