...
public class UnsupportedColumnInfo extends ComplexColumnInfo<UnsupportedValue> {
	...
	public UnsupportedColumnInfo(Column column, int complexId, Table typeObjTable, Table flatTable)
		throws IOException{
	...
	@Override
	protected UnsupportedValueImpl toValue(ComplexValueForeignKey complexValueFk,
