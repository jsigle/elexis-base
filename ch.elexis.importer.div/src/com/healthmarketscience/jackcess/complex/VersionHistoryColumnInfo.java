 ...
 * column.
 * <p>
 * Note, the strongly typed update/delete methods are <i>not</i> supported for version history
 * columns (the data is supposed to be immutable). That said, the "raw" update/delete methods are
 * supported for those that <i>really</i> want to muck with the version history data.
 * 
...
public class VersionHistoryColumnInfo extends ComplexColumnInfo<Version> {
	...
	public VersionHistoryColumnInfo(Column column, int complexId, Table typeObjTable,
	...
	public static Version newVersion(ComplexValueForeignKey complexValueFk, String value,
		Date modifiedDate){
	...
	private static class VersionImpl extends ComplexValueImpl implements Version {
		...
		private VersionImpl(int id, ComplexValueForeignKey complexValueFk, String value,
			Date modifiedDate){
