...
public class UsageMap {
	...
	private abstract class Handler {
		 ...
		 * @param force
		 *            true to force add/remove and ignore certain inconsistencies
		 */
		public abstract void addOrRemovePageNumber(int pageNumber, boolean add, boolean force)
			throws IOException;
	}
	...
	private class InlineHandler extends Handler {
		...
		@Override
		public void addOrRemovePageNumber(int pageNumber, boolean add, boolean force)
			throws IOException{
			if (isPageWithinRange(pageNumber)) {
	...
	private class ReferenceHandler extends Handler {
		...
		private final TempPageHolder _mapPageHolder = TempPageHolder
