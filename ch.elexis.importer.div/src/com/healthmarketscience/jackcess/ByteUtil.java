...
public final class ByteUtil {
	 ...
	 * 
	 * @param buffer
	 *            Buffer containing the desired bytes
	 * @param len
	 *            length of the desired bytes
	 * @return a new buffer with the given number of bytes from the current position in the given
	 *         buffer
	 */
	 ...
	 *            Buffer containing the desired bytes
	 * @param offset
	 *            Offset at which to read the bytes
	 * @param len
	 *            length of the desired bytes
	 * @return a new buffer with the given number of bytes from the given position in the given
	 *         buffer
	 */
	...
	/**
	 * Convert the given number of bytes from the given database page to a hexidecimal string for
	 * display.
	 */
