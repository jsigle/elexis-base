 ...
 * See {@link CodecProvider} for details on a more useful implementation.
 * 
...
public class DefaultCodecProvider implements CodecProvider {
	 ...
	 * {@inheritDoc}
	 * <p>
	 * This implementation returns DUMMY_HANDLER for databases with no encoding and
	 * UNSUPPORTED_HANDLER for databases with any encoding.
	 */
	...
	/**
	 * CodecHandler implementation which always throws UnsupportedCodecException, useful for
	 * databases with unsupported encodings.
	 */
	public static class UnsupportedHandler implements CodecHandler {
		...
		public ByteBuffer encodePage(ByteBuffer page, int pageNumber, int pageOffset)
			throws IOException{
			throw new UnsupportedCodecException(
				"Encoding not supported.  Please choose a CodecProvider which supports writing the current database encoding.");
		}
	}
