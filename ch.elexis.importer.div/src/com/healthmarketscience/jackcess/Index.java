...
/**
 * Access table (logical) index. Logical indexes are backed for IndexData, where one or more logical
 * indexes could be backed by the same data.
 * 
 * @author Tim McCune
 */
public class Index implements Comparable<Index> {
	...
	/**
	 * @return the Index referenced by this Index's ForeignKeyReference (if it has one), otherwise
	 *         {@code null}.
	 */
	 ...
	 */
	public IndexData.EntryCursor cursor(Object[] startRow, boolean startInclusive, Object[] endRow,
	...
	protected static void writeDefinitions(TableCreator creator, ByteBuffer buffer)
		...
		for (IndexBuilder idx : creator.getIndexes()) {
			...
			buffer.putInt(Table.MAGIC_TABLE_NUMBER); // seemingly constant magic value which matches
														// the table def
	...
	public static class ForeignKeyReference {
		...
		public String toString(){
			return new StringBuilder().append("\n\t\tOther Index Number: ")
				.append(_otherIndexNumber).append("\n\t\tOther Table Page Num: ")
				.append(_otherTablePageNumber).append("\n\t\tIs Primary Table: ")
				.append(isPrimaryTable()).append("\n\t\tIs Cascade Updates: ")
				.append(isCascadeUpdates()).append("\n\t\tIs Cascade Deletes: ")
				.append(isCascadeDeletes()).toString();
		}
	}
}
