...
public interface CodecHandler {
	...
	/**
	 * Encodes the given page buffer into a new page buffer and returns it. The returned page buffer
	 * will be used immediately and discarded so that it may be re-used for subsequent page
	 * encodings.
	 * 
	 * @param page
	 *            the page to be encoded, should not be modified
	 * @param pageNumber
	 *            the page number of the given page
	 * @param pageOffset
