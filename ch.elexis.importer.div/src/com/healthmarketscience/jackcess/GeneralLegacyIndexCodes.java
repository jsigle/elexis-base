...
/**
 * Various constants used for creating "general legacy" (access 2000-2007) sort order text index
 * entries.
 * 
...
public class GeneralLegacyIndexCodes {
	...
	private static final String EXT_CODES_FILE = Database.RESOURCE_PATH
	...
	private static final class ExtCodes {
		 ...
		 */
		private static final CharHandler[] _values = loadCodes(EXT_CODES_FILE, FIRST_EXT_CHAR,
			LAST_EXT_CHAR);
	}
	 ...
	 * of nifty codes).
	 */
	void writeNonNullIndexTextValue(Object value, ByteStream bout, boolean isAscending)
		throws IOException{
