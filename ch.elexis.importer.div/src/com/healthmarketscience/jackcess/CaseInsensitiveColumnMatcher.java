...
/**
 * Concrete implementation of ColumnMatcher which tests textual columns case-insensitively (
 * {@link DataType#TEXT} and {@link DataType#MEMO}), and all other columns using simple equality.
 * 
...
public class CaseInsensitiveColumnMatcher implements ColumnMatcher {
	...
	public boolean matches(Table table, String columnName, Object value1, Object value2){
		...
		try {
			...
			return ((cs1 == cs2) || ((cs1 != null) && (cs2 != null) && cs1.toString()
				.equalsIgnoreCase(cs2.toString())));
		} catch (IOException e) {
