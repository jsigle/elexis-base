 ...
 * encodings. The {@link DefaultCodecProvider} is the default implementation of this inferface, but
 * it does not have any actual encoding/decoding support (due to possible export issues with calling
 * encryption APIs). See the separate <a
 * href="https://sourceforge.net/projects/jackcessencrypt/">Jackcess Encrypt</a> project for an
...
public interface CodecProvider {
	 ...
	 * 
	 * @param channel
	 *            the PageChannel for a Database
	 * @param charset
